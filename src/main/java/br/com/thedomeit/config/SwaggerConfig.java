package br.com.thedomeit.config;
...
public class SwaggerConfig {
    ...
    public Docket api(ServletContext servletContext) {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .tags(new Tag("Expense", "These endpoints are used in Expense Record Maintenance Operations.", 1));
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Expense API")
                .description("This service handles Customer Registration CRUD operations")
                .version("1.0.0")
                .build();
    }
